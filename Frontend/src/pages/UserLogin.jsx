...
const UserLogin = () => {
  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between'>
      ...
      <div>
        <Link to='/captain-login' className='bg-[#08870a] flex items-center justify-center text-white mb-7  rounded px-2 py-2 w-full text-lg placeholder:text-base'>SignIn As Captain</Link>
      </div>
    </div>
  )
}
