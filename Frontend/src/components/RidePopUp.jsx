  ...
  return (
    <div className="max-w-sm mx-auto relative bg-white rounded-2xl shadow-lg p-4 space-y-4">
      ...
      <div className="flex justify-between pt-2">
        <button onClick={() => {
                props.setRidePopupPanel(false);
            }} className="px-5 py-2 rounded-xl border border-gray-300 text-gray-500 font-medium hover:bg-gray-100">
          Ignore
        </button>
        <button onClick={()=>{
          props.setConfirmRidePopupPanel(true);
        }} className="px-5 py-2 rounded-xl bg-green-600 text-white font-semibold shadow">
          Accept
        </button>
      </div>
    </div>
